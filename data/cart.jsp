...
document.addEventListener("DOMContentLoaded", function () {
    const selected = "${param.selectedVariantIds}";
    if (!selected) return;
...
<script>
    ...
    function searchVoucher() {
        ...
        let keyword = document.getElementById("searchVoucher").value.toLowerCase();
