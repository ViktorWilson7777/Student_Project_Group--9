...
public class CleanCode {
    ...
    static String[] brands = {"Nike", "Adidas", "Puma", "Gucci", "LouisVuitton", "Uniqlo", "Zara", "H&M"};
    ...
    static void generateShops(int total) throws IOException {
        FileWriter fw = new FileWriter("Shops.csv");
        ...
        for (int shopID = 1; shopID <= total; shopID++) {
            ...
            if (useOwnerName) {
                // Shop trùng owner
                shopName = "Shop " + userNames[ownerUserID];
            } else {
                // Shop random
                shopName = "Shop "
    ...
    static void generateVariants(int products) throws IOException {
        FileWriter fw = new FileWriter("ProductVariants.csv");
    ...
    static void generateVouchers(int total) throws IOException {
        FileWriter fw = new FileWriter("Vouchers.csv");
